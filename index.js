...
module.exports = (eleventyConfig, options) => {
  const {outputDir, manifestData, generateManifest} = Object.assign({}, defaultOptions, options);
  // favicons shortcode
  // examples:
  ...
  eleventyConfig.addAsyncShortcode('favicons', async (sourceFile, opts) => {
    const favOpts = Object.assign({manifestData: manifestData, generateManifest: generateManifest}, opts);
